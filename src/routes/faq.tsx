...
const faqs = [
  { q: "How are housekeepers verified?", a: "Every professional completes government ID verification with biometric matching, a comprehensive criminal background check, and a professional reference review before their profile goes live. Verification is renewed annually." },
  ...
  { q: "How do I become a provider?", a: "Apply online in under 10 minutes. You'll complete identity verification (18+), a background check, and profile setup. Most applicants are approved within 7 days." },
